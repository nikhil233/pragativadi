...
if(isset($_GET['id']) && $_GET['id']>0){
    ...
    $result=$crud->getData("SELECT news_posts.*,cities.city_name from news_posts,cities WHERE news_posts.id=$id and cities.id=news_posts.city_id ");
...
if(isset($_POST['submit'])){
    ...
    $result= $crud->execute("UPDATE news_posts set city_id='$city_id' ,news_date='$news_date',status='$status' where id='$id' ");
