...
if(isset($_GET['id'])){
  ...
  $result=$crud->delete( $id ,'magazine_posts');
  redirect('magazine_list.php');
}
$sql="SELECT magazine_posts.id,magazine_posts.mag_date,magazine_posts.status,cities.city_name from magazine_posts,cities where cities.id=magazine_posts.city_id order by magazine_posts.id desc";
  ...
  <div class="container-fluid">
          <div class="card">
            ...
            <div style="display:flex; justify-content:space-between;">
              ...
              <a href="add_magazine.php" class="add_link btn btn-outline-primary" >Add Posts</a>
              </div>
              </div>
                      ...
                      <tbody>
                        ...
                        ?>
                            ...
                            <style>
                                ...
                                <a href="edit_mag_post.php?id=<?php echo $res['id'] ?> "> <button class="btn btn-outline-primary">Edit</button></a>
